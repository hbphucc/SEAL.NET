...
const NAV_ITEMS: NavItem[] = [
  ...
  { label: "Judge Dashboard", href: "/judge/dashboard", icon: ClipboardCheck, roles: ["Judge"] },
  { label: "Judge Submissions", href: "/judge/submissions", icon: FileText, roles: ["Judge"] },
  { label: "Mentor Dashboard", href: "/mentor/dashboard", icon: Handshake, roles: ["Mentor"] },
  { label: "My Team", href: "/my-team", icon: Users2, roles: ["Member", "TeamLeader"] },
  { label: "Submit Project", href: "/submit", icon: Send, roles: ["Member", "TeamLeader"] },
